...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  if (locale !== langParam) {
    const target = locale === defaultLocale ? "/services" : `/${locale}/services`;
  ...
  const successStoriesHref = `/${locale}/success-stories`;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "locale": locale, "messages": messages, "alternateLinks": alternateLinks, "languageSwitcher": languageSwitcher, "pageMeta": pageCopy.meta, "additionalStructuredData": [faqStructuredData] }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ServicesPage", $$ServicesPage, { "services": messages.services, "contact": messages.contact, "footerContact": messages.footer.contact, "copy": pageCopy, "successStoriesHref": successStoriesHref, "contactHref": "#contact" })} ${renderComponent($$result2, "ContactSection", $$ContactSection, { "contact": messages.contact, "phoneNumber": messages.footer.contact.phone })} ` })}`;
}, "/Users/pedro412/astro-horizon/agreeable-asteroid/src/pages/[lang]/services/index.astro", void 0);

const $$file = "/Users/pedro412/astro-horizon/agreeable-asteroid/src/pages/[lang]/services/index.astro";
